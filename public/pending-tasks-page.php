...
try {
    $stmt = $pdo->prepare("SELECT * FROM tasks WHERE user_id = ? AND status = 'Pending' ORDER BY due_date ASC");
...
<head>
    ...
    <title>TaskHub - Pending Tasks</title>
    ...
    <div class="main-container">
        ...
        <div class="content">
            <div class="content-header">
                <h1 class="content-title">Pending Tasks</h1>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p class="empty-state-message">You don't have any pending tasks at the moment.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
